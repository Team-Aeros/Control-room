...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.retranslateUi(MainWindow)
        self.Manual.clicked.connect(MainWindow.toggleManual)
        self.Graphs.clicked.connect(MainWindow.showGraphs)
        self.Settings.clicked.connect(MainWindow.changeSettings)
        self.Info.clicked.connect(MainWindow.showInfo)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)
